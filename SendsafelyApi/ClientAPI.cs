...
namespace SendsafelyApi
{
    ...
    public class ClientAPI
    {
        ...
        {
            InitialSetup(host, apiKey, apiSecret, null);
        }
        ...
        {
            var su = new StartupUtility(host, apiSecret, apiKey, proxy);
            _connection = su.GetConnectionObject();
        }
        ...
        {
            _connection = new Connection(host, proxy);
        }
        ...
        public void AddContactGroupToPackage(string packageId, string groupId)
        {
            ...
            var pu = new PackageUtility(_connection);
        ...
        /// The unique group id of the created Contact Group. This value is required for subsequent Contact Group management operations.  
        /// </returns>
        public string CreateContactGroup(string groupName, bool isEnterpriseGroup)
        {
            EnforceInitialized();
        ...
        public Directory CreateDirectory(string packageId, string parentDirectoryId, string directoryName)
        {
            ...
            var pu = new PackageUtility(_connection);
            var directoryId = pu.CreateDirectory(packageId, parentDirectoryId, directoryName);
            return GetDirectory(packageId, directoryId);
        }
        ...
        public File EncryptAndUploadFile(string packageId, string path, ISendSafelyProgress progress)
        {
            ...
            try
            {
                keyCode = _connection.GetKeycode(packageId);
            }
        ...
        public File EncryptAndUploadFile(string packageId, string keyCode, string path, ISendSafelyProgress progress, string uploadType)
        {
            ...
            var file = pu.EncryptAndUploadFile(packageId, keyCode, path, progress, uploadType);
            return file;
        }
        ...
        public File EncryptAndUploadFileInDirectory(string packageId, string directoryId, string keyCode, string path, ISendSafelyProgress progress, string uploadType)
        {
            ...
            var file = pu.EncryptAndUploadFile(packageId, directoryId, keyCode, path, progress, uploadType);
            return file;
        }
        ...
        {
            var util = new RegistrationUtility(_connection);
        ...
        public PrivateKey GenerateKeyPair(string description)
        {
            ...
            var utility = new PublicKeyUtility(_connection);
        ...
        public EnterpriseInformation GetEnterpriseInfo()
        {
            ...
            var util = new EnterpriseUtility(_connection);
        ...
        public string GetPackageLink(string packageId, string keyCode)
        {
            ...
            var workspaceLink = _connection.ApiHost + "/receive/?packageCode=" + packageInfo.PackageCode + "#keycode=" + keyCode;
        ...
        public User GetUserInformation()
        {
            ...
            var su = new StartupUtility(_connection);
        ...
        {
            var handler = new ParseLinksUtility();
        ...
        public string VerifyCredentials()
        {
            ...
            var su = new StartupUtility(_connection);
            var email = su.VerifyCredentials();
            return email;
        }
        ...
        public Objects.Version VerifyVersion()
        {
            ...
            var su = new StartupUtility(_connection);
            var versionResponse = su.VerifyVersion();
        ...
        {
            _connection.OutlookVersion = version;
        }
